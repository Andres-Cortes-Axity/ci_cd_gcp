...
def main():
    ...
    #parser.add_argument('--output_dir', choices=['/workspace/analysis_reports'], default='/workspace/analysis_reports', help='Output format for the report (default: text)')
    ...
    # Output the report
    if args.output == 'html':
        with open(f"/workspace/analysis_reports/{args.filepath[8:-4]}_ddl_analysis_report.html", 'w') as file:
            file.write(report_output)
        print("Report generated: "+args.filepath+'_ddl_analysis_report.html')
    else:
        print(report_output)
